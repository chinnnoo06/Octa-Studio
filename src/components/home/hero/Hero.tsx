        ...
        <div className="mt-10 flex flex-col justify-between gap-8 sm:mt-14 md:mt-20 md:gap-10 md:min-h-135 lg:min-h-200">
          ...
          <div className="mx-auto flex w-full max-w-[1700px] flex-col items-center gap-8 px-5 lg:gap-10 md:flex-row md:items-start md:justify-start md:gap-10">
            ...
            <div className="w-full md:w-fit md:min-w-0">
              <h1 className="text-primary/75 font-display px-[0.08em] pb-[0.14em] text-center md:text-end
                   text-[3.5rem] sm:text-[4rem] md:text-[3.5rem] lg:text-[5.5rem] xl:text-[7rem] 2xl:text-[8rem]
            ...
            <div className="flex w-full flex-col items-center gap-5 md:w-auto md:flex-row md:items-start md:gap-6 lg:gap-10">
              <TickLine className="text-primary hidden md:flex" />

              <div className="hidden md:flex md:flex-col md:gap-5">
                <p className="text-primary font-text text-base tracking-[0.15em] uppercase">
                  Qué montamos
                </p>

                <ul role="list" className="divide-primary/25 flex flex-col divide-y">
                  <li className="flex items-baseline gap-5 pb-5">
                    <span className="text-primary font-text text-sm tracking-[0.15em]">
                      01
                    </span>
                    <span className="text-primary font-text text-sm leading-none lg:text-base">
                      Stands y ferias
                    </span>
                  </li>
              ...
              <div className="flex flex-col items-center gap-5 md:hidden">
                ...
                <p className="flex items-center gap-2.5">
                  <span className="text-primary font-text text-5xl leading-none">
                    20
                  </span>
                  <span className="text-primary/75 font-text text-center text-xs font-medium tracking-[0.15em] uppercase">
                    años de montajes
                    <br />
                ...
                <h2 className="text-primary font-text text-center text-base leading-snug uppercase sm:text-lg">
                  Todo desde cero{' '}
          ...
          <div className="mx-auto flex w-full max-w-[2000px] items-center justify-between gap-10">
            ...
            <div className="hidden max-w-100 items-center gap-2.5 md:flex md:ml-[max(0px,calc((100%-1700px)/2))] px-5">
              <TickLine className="text-primary" />
            ...
            <div className="bg-primary border-primary ml-auto w-full overflow-hidden rounded-t-xl border-5 lg:max-w-170 lg:border-10">
              <HeroSlider />
            </div>
          </div>
        </div>
