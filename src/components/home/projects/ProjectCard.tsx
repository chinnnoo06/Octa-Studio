  ...
  return (
    ...
    >
      ...
      <div className="bg-secondary/15 group-hover:bg-secondary flex w-12 shrink-0 flex-col items-center justify-between gap-5 py-5 transition-colors duration-300 lg:w-16">
        <h3 className="text-secondary rotate-180 text-base font-medium uppercase transition-colors duration-300 group-hover:text-white lg:text-xl [writing-mode:vertical-rl]">
          {project.name}
        </h3>
        <p className="text-secondary rotate-180 text-base font-medium uppercase transition-colors duration-300 group-hover:text-white lg:text-xl [writing-mode:vertical-rl]">
          {project.sector}
        </p>
      </div>
