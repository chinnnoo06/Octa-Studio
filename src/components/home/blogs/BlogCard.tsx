  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl">
        ...
        />
        <span className="bg-primary text-secondary absolute top-2.5 left-2.5 rounded-lg px-2.5 py-1 font-gentleman text-3xl lg:text-4xl leading-[0.6] font-normal tracking-[0.04em] normal-case">
          {post.category}
        </span>
      </div>
